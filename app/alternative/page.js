    ...
    <main style={{ maxWidth: 960, margin: "0 auto", padding: "40px 20px", color: "#0f172a" }}>
      ...
      >
        ...
        <div style={{ marginTop: 20, display: "grid", gap: 12, gridTemplateColumns: "repeat(2, minmax(0, 1fr))" }}>
          ...
          <a href="/final-picks" style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", height: 48, borderRadius: 14, border: "1px solid #dbe3f0", textDecoration: "none", color: "#0f172a", fontWeight: 800 }}>실전투자 보기</a>
        </div>
      </div>
    </main>
  );
