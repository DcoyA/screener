...
// STEP 8: history.json / stocks.json 을 클라이언트에서 직접 import 하던 걸
// 서버 컴포넌트(page.js)가 읽어 props로 내려주도록 바꿨다. stocks 는
// buildPerformanceData 가 실제로 읽는 필드만 담긴 slim 배열이다.
// 집계 로직(buildPerformanceData)과 렌더는 한 줄도 바꾸지 않았다.
...
export default function PerformanceClient({ history, stocks }) {
