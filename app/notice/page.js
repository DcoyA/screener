...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "프리미엄 리포트는 OpenDART 공시와 KRX 시장 데이터를 기반으로 재무 안정성, 저평가 여부, 시장성, 변화 흐름 등을 종합 반영해 선정한 종목을 중심으로 발송됩니다. 화요일에는 상위 후보 종목 상세 분석 리포트가, 목요일에는 한 주 흐름을 정리하는 복기 리포트가 발송됩니다.",
  },
  {
    id: 3,
    question: "무료 서비스인가요?",
