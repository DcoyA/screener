...
export const styles = {
  // 배경(var(--page-bg))은 뷰포트 전체에 꽉 채우고(풀블리드), 실제 콘텐츠 폭만 pageInner로 제한한다.
  ...
  logo: { fontSize: "14px", fontWeight: "800", color: "var(--ruby-700)", marginBottom: "6px" },
  title: { margin: 0, fontSize: "34px", fontWeight: "900" },
  subTitle: { margin: "8px 0 0", color: "#4b5563", lineHeight: 1.55 },
  accountBox: { minWidth: "260px", background: "var(--ruby-950)", color: "white", borderRadius: "18px", padding: "18px", boxShadow: "0 10px 26px rgba(15,23,42,0.16)" },
  linkButton: { marginTop: "8px", fontSize: "13px", background: "none", border: "none", color: "var(--ruby-700)", textDecoration: "underline", cursor: "pointer", padding: 0 },
  ...
  fomoTip: { background: "var(--ruby-50)", border: "1px solid var(--ruby-300)", borderRadius: "12px", padding: "12px 16px", marginBottom: "12px", display: "flex", justifyContent: "space-between", alignItems: "center", gap: "12px", fontSize: "13px", color: "var(--ruby-700)" },
  accountLine: { fontSize: "13px", color: "#9ca3af", marginBottom: "8px" },
  accountId: { fontSize: "20px", fontWeight: "900", letterSpacing: "-0.02em" },
  accountPin: { marginTop: "8px", color: "var(--gold-300)", fontWeight: "800" },
  primaryButton: { border: 0, background: "var(--signal-down)", color: "white", borderRadius: "12px", padding: "12px 16px", fontWeight: "800", cursor: "pointer", whiteSpace: "nowrap" },
  ...
  searchButton: { border: 0, background: "var(--ruby-700)", color: "white", borderRadius: "12px", padding: "0 10px", fontWeight: "800", cursor: "pointer", whiteSpace: "nowrap", wordBreak: "keep-all", minWidth: "48px" },
  ...
  stockButtonActive: { borderColor: "var(--signal-down)", background: "var(--ruby-50)", color: "var(--ruby-700)", boxShadow: "inset 0 0 0 1px var(--signal-down)" },
  ...
  upText: { color: "var(--signal-up)" },
  downText: { color: "var(--signal-down)" },
  chartPanel: { background: "var(--ruby-950)", borderRadius: "18px", padding: "16px", overflow: "hidden" },
  ...
  chartWarning: { background: "var(--warn-bg)", border: "1px solid var(--gold-500)", color: "var(--gold-300)", borderRadius: "10px", padding: "8px 10px", fontSize: "12px", marginBottom: "10px" },
  ...
  buyMarker: { background: "var(--signal-up)" },
  sellMarker: { background: "var(--signal-down)" },
  fomoBox: { marginTop: "16px", background: "var(--warn-bg)", border: "1px solid var(--warn-bg)", borderRadius: "16px", padding: "16px", display: "flex", justifyContent: "space-between", alignItems: "center", gap: "12px" },
  ...
  buyTabActive: { border: "1px solid var(--signal-up)", background: "#fdecec", color: "var(--signal-up)", borderRadius: "12px", padding: "12px", fontWeight: "900", cursor: "pointer" },
  sellTabActive: { border: "1px solid var(--signal-down)", background: "var(--ruby-100)", color: "var(--signal-down)", borderRadius: "12px", padding: "12px", fontWeight: "900", cursor: "pointer" },
  label: { display: "block", fontSize: "13px", fontWeight: "800", color: "#374151", margin: "12px 0 6px" },
  holdingInfo: { marginTop: "8px", padding: "10px 12px", background: "var(--ruby-50)", border: "1px solid var(--ruby-300)", borderRadius: "12px", color: "var(--ruby-700)", fontSize: "13px", fontWeight: "800" },
  ...
  buyButton: { width: "100%", border: 0, background: "var(--signal-up)", color: "white", borderRadius: "14px", padding: "15px", fontSize: "16px", fontWeight: "900", marginTop: "16px", cursor: "pointer" },
  sellButton: { width: "100%", border: 0, background: "var(--signal-down)", color: "white", borderRadius: "14px", padding: "15px", fontSize: "16px", fontWeight: "900", marginTop: "16px", cursor: "pointer" },
  orderStatus: { marginTop: "12px", textAlign: "center", fontWeight: "900", color: "var(--ruby-700)" },
  ...
  tableRow: { display: "grid", gridTemplateColumns: "1.1fr 0.45fr 0.9fr 0.9fr 0.9fr 0.9fr", padding: "12px 10px", borderBottom: "1px solid var(--page-bg)", fontSize: "13px", gap: "8px", alignItems: "center" },
